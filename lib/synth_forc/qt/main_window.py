...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.grp_size_distribution_parameters, 4, 0, 2, 1)
        self.graphics_loops = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphics_loops.setObjectName("graphics_loops")
        self.gridLayout.addWidget(self.graphics_loops, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.graphics_forcs, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbl_size_distribution, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.grp_aratio_distribution_parameters, 4, 1, 2, 1)
        ...
        self.gridLayout.addWidget(self.lbl_aratio_distribution, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.graphics_aratio_distribution, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.graphics_size_distribution, 3, 0, 1, 1)
        self.grp_commands = QtWidgets.QGroupBox(self.centralwidget)
        ...
        self.gridLayout.addWidget(self.grp_commands, 6, 0, 1, 1)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1236, 37))
        ...
        MainWindow.setTabOrder(self.graphics_forcs, self.graphics_loops)
        MainWindow.setTabOrder(self.graphics_loops, self.graphics_size_distribution)
